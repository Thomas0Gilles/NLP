...
hyperparameters = { 'classifier__learning_rate': [0.01, 0.03, 0.1, 0.3],
                    'classifier__n_estimators': [20, 30, 50, 70, 100, 150],
                    'classifier__max_depth': [2, 4, 8, 16],
                    'classifier__min_samples_leaf': [2, 4, 5],
                    'classifier__verbose':[1]
                  }
clf = GridSearchCV(pipeline, hyperparameters, cv = 10, scoring = gini_score)
