...
df_test.drop(['city','bd','gender','registered_via','registration_init_time','total_order','plan_net_worth','mean_payment_each_transaction','total_actual_payment','cancel_times'],axis=1,inplace=True)
